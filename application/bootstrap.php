...
class Bootstrap extends Zend_Application_Bootstrap_Bootstrap {
	...
	public function _initRoutes(){
		...
		foreach($menulist as $key => $menuitem){ 
			$menu[$menuitem['id']] = $menuitem['malias'];
		}
		...
		foreach ($menu as $value){
			...
			$route = new Zend_Controller_Router_Route($value, 
						array(
							'controller' => 'menu',
			                'action' => 'item',
							'alias' => $value
	        ...
	        $frontController->getRouter()->addRoute($value, $route);
		}
        
        /*$frontController  = Zend_Controller_Front::getInstance();
        $route = new Zend_Controller_Router_Route('index/:menu', 
					array(
						'controller' => 'menu',
		                'action' => 'item',
		                'menu' => 1
		...
		$frontController->getRouter()->addRoute('index', $route);*/
